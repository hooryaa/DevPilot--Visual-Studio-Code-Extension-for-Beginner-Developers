...
type ChartTooltipContentProps = {
  ...
  labelFormatter?: ((label: any, payload?: RechartsPayloadItem[]) => React.ReactNode) | undefined;
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const item: RechartsPayloadItem | undefined = payload[0];
...
type ChartLegendContentProps = {
  className?: string;
  hideIcon?: boolean;
  payload?: RechartsPayloadItem[] | any[] | undefined;
...
function getPayloadConfigFromPayload(
  ...
  return (configLabelKey in config
    ...
    : (config[key as keyof typeof config] as any)) as
    | {
        label?: React.ReactNode;
        icon?: React.ComponentType;
      }
