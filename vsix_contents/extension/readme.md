...
<p align="center">
  <img src="https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/icon.jpg" width="180" alt="DevPilot Logo">
</p>
...
![Stars](https://img.shields.io/github/stars/hooryaa/
...
![DevPilot Demo](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/DevPilot.gif)
...
|-----------|-------|
| ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/Dashboard.png) | ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/DevAI.png) |

| Hover Definitions & Suggestions | Git Commit Message Generation |
|--------|-----|
| ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/Hover.png) | ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/Git.png) |

| Learning Resources | Translation & Tips |
|----------|-------------|
| ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/LearningResources.png) | ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/Translation.png) |
...
|-------------------|-----------|
| ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/StreakTranslate.png) | ![](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/raw/HEAD/media/screenshots/TodoSync.png) |
...
For privacy and data handling details, see [docs/PRIVACY_POLICY.md](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/blob/HEAD/docs/PRIVACY_POLICY.md).
...
See [LICENSE](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/blob/HEAD/LICENSE) and [TRADEMARK.md](https://github.com/hooryaa/DevPilot--Visual-Studio-Code-Extension-for-Beginner-Developers/blob/HEAD/TRADEMARK.md) for details.
